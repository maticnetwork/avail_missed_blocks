...
exports.MissedBlockHandler = void 0;
var missedblock_1 = require("../models/missedblock");
var missedBlockModel = new missedblock_1.MissedBlockModel();
var MissedBlockHandler = /** @class */ (function () {
    function MissedBlockHandler() {
    }
    MissedBlockHandler.prototype.index = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, missedBlockModel.index()];
                    case 1:
                        result = _a.sent();
